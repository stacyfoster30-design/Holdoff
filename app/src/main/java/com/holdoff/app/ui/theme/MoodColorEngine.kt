...
object MoodColorEngine {
    ...
    fun paletteFor(mood: Mood): MoodPalette = when (mood) {
        Mood.CALM -> MoodPalette(
            primary = Color(0xFF6E59C7),     // soft violet
        ...
        Mood.ANXIOUS -> MoodPalette(
            primary = Color(0xFF8A5BD0),     // electric violet — alert but not red
        ...
        Mood.ANGRY -> MoodPalette(
            primary = Color(0xFF7C2B7A),     // dark magenta in the velvet family
        ...
        Mood.HURT -> MoodPalette(
            primary = Color(0xFF4A3A8C),     // bruised indigo
        ...
        Mood.HOPEFUL -> MoodPalette(
            primary = Color(0xFF5A78D6),     // romantic deep blue
        ...
        Mood.NUMB -> MoodPalette(
            primary = Color(0xFF3F3A6E),     // muted dusk
        ...
        Mood.EXCITED -> MoodPalette(
            primary = Color(0xFF7A5BE0),     // glowing violet
        ...
        Mood.AVOIDANT -> MoodPalette(
            primary = Color(0xFF334C8A),     // distant deep blue
